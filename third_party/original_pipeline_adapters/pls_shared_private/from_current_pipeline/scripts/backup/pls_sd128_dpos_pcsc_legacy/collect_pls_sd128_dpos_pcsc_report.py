...
BASE = NEW_BASE / "results/pls_sd128_dpos_pcsc"
...
def main():
    ...
    tsv = report_dir / "pls_sd128_dpos_pcsc_runs.tsv"
    fields = [
    ...
    md = report_dir / "PLS_SD128_DPOS_PCSC_Report.md"
    lines = [
        "# PLS sd128 + dpos C4 + hard PCSC report\n\n",
