...
from order_ablation_modeling_patch import OrderAwareMatchedCurriculumLETTER
from utils import (
    ensure_dir,
    load_datasets,
    parse_dataset_args,
...
def main(args):
    ...
    model = OrderAwareMatchedCurriculumLETTER(
        config,
        mode="zcf",
        ...
        json.dumps(
            {
                ...
                "pcsc_aux": args.pcsc_aux,
                "chord_order": args.chord_order,
                "pcsc_mapping": model.pcsc_mapping_summary(),
                "pcsc_max_factor": args.pcsc_max_factor,
                "pcsc_schedule_type": args.pcsc_schedule_type,
                "lambda_cf": args.lambda_cf,
                "lambda_cfres": args.lambda_cfres,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--chord_order", choices=["cf_first", "sem_first"], default="cf_first")
