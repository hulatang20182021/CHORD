...
def main() -> None:
    ...
    log_paths = [
        report_dir / f"beauty_component_relation_sid_v2_llama_20epoch_seed{args.seed}.log",
    ...
    output = {
        "dataset": "Beauty_component_relation_sid_v2_llama",
        "seed": args.seed,
    ...
    json_path = report_dir / "beauty_v2_llama_training_status.json"
    md_path = report_dir / "beauty_v2_llama_training_status.md"
    json_path.write_text(json.dumps(output, ensure_ascii=False, indent=2) + "\n", encoding="utf-8")
    md_path.write_text(
        "# Beauty Component-Relation SID V2-Llama Training Status\n\n"
