# Beauty CF-only ST5-RQ-VAE Static Audit
...
```json
{
  "methods": [
    ...
    {
      "method": "Beauty_cf_only_lam010_st5_rqvae",
      "full_sid_duplicate_count": 0,
      "total_token_vocab_size": 499,
      "c1_vocab_size": 61,
      "c2_vocab_size": 170,
      "c3_vocab_size": 256,
      "c4_vocab_size": 12,
      "compact_c4_vocab_size": 12,
      "max_prefix3_bucket_size": 12,
      "index_all_ratio_freq_le_5": 0.022044088176352707,
      "exposure_all_ratio_freq_le_5": 0.002004008016032064,
      "per_position_index_low_freq": [
        0.06557377049180328,
      ...
      "prefix1_mean_bucket_size": 198.37704918032787,
      "prefix2_mean_bucket_size": 2.23471837488458,
      "prefix3_mean_bucket_size": 1.037999656887974,
      "c1c2_singleton_ratio": 0.4755309325946445,
      "c1c2c3_singleton_ratio": 0.971350145822611,
      "prefix1_lift": 11.754973821989529,
      "prefix2_lift": 79.66071428571429,
      "prefix3_lift": 325.99999999999994
    }
  ],
  "cf_alignment": {
    "c1_vs_cf_cluster": {
      "nmi": 0.4501132994573178,
      "purity": 0.15345839186844062,
      "entropy_mean": 3.199300212526743
    },
    "c1_vs_product_type": {
      "nmi": 0.2641515607944493,
      "purity": 0.30096686224278985,
      "entropy_mean": 2.423366876692488
    },
    "c1_vs_original_c1": {
      "nmi": 0.44732929566027596
    },
    "c2_vs_cf_cluster": {
      "nmi": 0.3291899155718117,
      "purity": 0.09900008263779853,
      "entropy_mean": 3.637658083311951
    },
    "c2_vs_product_type": {
      "nmi": 0.16639939354163463,
      "purity": 0.2511362697297744,
      "entropy_mean": 2.7398739944977826
    },
    "c2_vs_original_c2": {
      "nmi": 0.2850830573651111
    },
    "c3_vs_cf_cluster": {
      "nmi": 0.32726045923659464,
      "purity": 0.06313527807619206,
      "entropy_mean": 3.616150861056454
    },
    "c3_vs_product_type": {
      "nmi": 0.16672455323622354,
      "purity": 0.24072390711511446,
      "entropy_mean": 2.7329011438062514
    },
    "c3_vs_original_c3": {
      "nmi": 0.3230527630656935
    }
  }
}
```
