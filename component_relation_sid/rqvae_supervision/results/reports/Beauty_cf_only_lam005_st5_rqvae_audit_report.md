...
```json
{
  "methods": [
    ...
    {
      "method": "Beauty_cf_only_lam005_st5_rqvae",
      "full_sid_duplicate_count": 0,
      "total_token_vocab_size": 590,
      "c1_vocab_size": 85,
      "c2_vocab_size": 244,
      "c3_vocab_size": 256,
      "c4_vocab_size": 5,
      "compact_c4_vocab_size": 5,
      "max_prefix3_bucket_size": 5,
      "index_all_ratio_freq_le_5": 0.011864406779661017,
      "exposure_all_ratio_freq_le_5": 0.0,
      "per_position_index_low_freq": [
      ...
      "prefix1_mean_bucket_size": 142.36470588235295,
      "prefix2_mean_bucket_size": 1.6111037145519904,
      "prefix3_mean_bucket_size": 1.0201483729556566,
      "c1c2_singleton_ratio": 0.6507788576754094,
      "c1c2c3_singleton_ratio": 0.9828022255943348,
      "prefix1_lift": 16.009057225195555,
      "prefix2_lift": 167.07142857142856,
      "prefix3_lift": null
    }
  ],
  "cf_alignment": {
    "c1_vs_cf_cluster": {
      "nmi": 0.4874033139701228,
      "purity": 0.20444591356086275,
      "entropy_mean": 3.0388459709522166
    },
    "c1_vs_product_type": {
      "nmi": 0.2686935809188662,
      "purity": 0.3086521775059912,
      "entropy_mean": 2.4413515740510934
    },
    "c1_vs_original_c1": {
      "nmi": 0.45064458349152914
    },
    "c2_vs_cf_cluster": {
      "nmi": 0.351054984010336,
      "purity": 0.09222378315841666,
      "entropy_mean": 3.435361279583019
    },
    "c2_vs_product_type": {
      "nmi": 0.17960682996554045,
      "purity": 0.24807867118419966,
      "entropy_mean": 2.6418963385106995
    },
    "c2_vs_original_c2": {
      "nmi": 0.32590441482053606
    },
    "c3_vs_cf_cluster": {
      "nmi": 0.323503361985901,
      "purity": 0.057681183373274936,
      "entropy_mean": 3.6219092435583464
    },
    "c3_vs_product_type": {
      "nmi": 0.1636134037430571,
      "purity": 0.23832741095777207,
      "entropy_mean": 2.744012496301353
    },
    "c3_vs_original_c3": {
      "nmi": 0.319949159065463
    }
  }
}
```
