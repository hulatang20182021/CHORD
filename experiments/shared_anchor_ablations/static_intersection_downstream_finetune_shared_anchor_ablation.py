...
from modeling_shared_anchor_ablation import MatchedCurriculumLETTER
from utils import (
    ensure_dir,
    load_datasets,
    parse_dataset_args,
...
def main(args):
    ...
    contract = {
        ...
        "ablation_variant": args.pcsc_ablation_variant,
        "contract": (
    ...
    model = MatchedCurriculumLETTER(
        ...
        pcsc_ablation_variant=args.pcsc_ablation_variant,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pcsc_ablation_variant", required=True)
